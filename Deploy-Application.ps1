...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## <Perform Installation tasks here>
     	Execute-Process -Path "$dirFiles\Quartus-web-13.0.1.232-windows\QuartusLite\QuartusSetupWeb-13.0.1.232.exe" -Parameters '--mode unattended --unattendedmodeui none --installdir C:\Quartus\13.0sp1\' -WindowStyle 'Hidden' -PassThru
			Execute-Process -Path "$dirFiles\Quartus-web-13.0.1.232-windows\ModelSim\ModelSimSetup-13.0.1.232.exe" -Parameters '--mode unattended --unattendedmodeui none --installdir "C:\Quartus\13.0sp1" --modelsim_edition modelsim_ase' -WindowStyle 'Hidden' -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'quartus, quartus_pgmw, ,jtagserver, quartus_sh, quartus_dsew, modelsim, esclipse-nios2' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBTlLIBlXx8/jKW
# nSQmOvczKq4g9G8kTx9D5GFRhDN3LaCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgDELx05tx
# qx7FsrjD15Eh9x6ZpqpdFNyurOwBH+rGqOEwDQYJKoZIhvcNAQEBBQAEggEAaNXh
# p5GFT1+Gngm+XbkwcPZiNA3SqDNXA072Bi1uOdzRo+MjIYzMOS1y44TYUchfM/pf
# WLDyTzJiMzFtJF73lWwrEsLLbV6+GADXG3CXOLIp5wB5AfKc1yV1E5UFnfkgzvkV
# riTmq3tYKlgXGgwETy6h7ja2CvpZWQtpkprCs3ULFIEkDtdyULAfoImOiXZXtvVs
# drLLt4d9IVE7r1cegvc54lty9YzQyU+4DkCos582jUdS7jcivx7zFXIwfF+U62uS
# mniZl1q0oTAEG2XwsEccSP0oV6uirPrc7olcEi2+2wIyQqeJ7EUC3Ixol9/tIoP5
# 4AEsuYJ6sS9CN08PQKGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xODA4MDYxMzUwMDdaMCMGCSqGSIb3DQEJBDEWBBQmKz+q
# DzZmaGMjJJaGuXYKhEr9fTCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEASl1hoGseg9Wwb2fUoYeaIspjoSrTKDvmhuO+nLZ5znUBJbut+le0IH2C4uT8
# /t3irEXeyyHrB2Lpal02zsCRPq0xMujJiKMsZbSMvNK8sFUCohgijR39LT7+Byh3
# pXFZBcuz4ulVL5gdN5VbG3SmlYTw7pIeYjyei9DAlgpARIPw94SAmmruutDHPkR8
# cCQJ/KgsUqcghFvUpLyNflMIgaEOGMrFcfknZsy6CDIRsRzOgjlufwcmZA8bHgwA
# pT93cYUfhYom02jfb+qT0VYkqLmjs2sImMMn98qIHRUMyPtjL6kpytFsupuDICti
# hOZTkUlTGFbdegG1dcSie0doXQ==
